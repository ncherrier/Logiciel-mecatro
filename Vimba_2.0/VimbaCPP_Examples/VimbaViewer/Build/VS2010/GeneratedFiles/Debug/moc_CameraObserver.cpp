...
QT_MOC_LITERAL(1, 15, 16), // "updateDeviceList"
...
void CameraObserver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CameraObserver::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CameraObserver::updateDeviceList)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CameraObserver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CameraObserver.data,
      qt_meta_data_CameraObserver,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CameraObserver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "AVT::VmbAPI::ICameraListObserver"))
        return static_cast< AVT::VmbAPI::ICameraListObserver*>(const_cast< CameraObserver*>(this));
