...
QT_MOC_LITERAL(4, 34, 8) // "validate"

    },
    "CameraSettingsWindow\0reset\0\0apply\0"
    "validate"
};
...
void CameraSettingsWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CameraSettingsWindow *_t = static_cast<CameraSettingsWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject CameraSettingsWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CameraSettingsWindow.data,
      qt_meta_data_CameraSettingsWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CameraSettingsWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CameraSettingsWindow.stringdata0))
        return static_cast<void*>(const_cast< CameraSettingsWindow*>(this));
